...
Export data from a scatter plot figure. Execute with an input image as:
    python export_scatter.py -i image_filepath
...
while select_new_line:
    ...
    # Extract centerpoint of each contour
    data_x = []
    data_y = []    
    ...
    for i, c in enumerate(contours):
        ...
        if M["m00"]>0:
            ...
            data_x.append( cX - origin[0] )    
            data_y.append( origin[1] - cY )
    ...
    print('Series #%d with %d points exported!' % (line_id,len(data_x) ))
